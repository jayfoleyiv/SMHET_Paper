...
transitions of our PIW Pt NC model.  We consider
...
nearfield enhancement in the vicinity of the Pt NC, while the nearfield $|{\bf E}|/|{\bf E_0}|$ is much smaller (approximately 2)
on the Pt NC at its extinction maximum ($\lambda=200nm$, see Figure 2 (a), (b), and (c)).
The WGMs supported by the $d=685$ dielectric NS show much greater efficiency in creating hot-holes in the lowest lying orbital ($E_F - 1.6 eV$) and creating hot-electrons in the highest 
lying orbital in the PIW Pt NC active space (see Figure 2 (e) and (f)).  The hot-carriers also show much more persistent dynamics
compared to those driven by FP modes on the $d=285nm$ dielectric NS or driven by the relatively weak optical
response of the $L=2nm$ Pt NC (see Figure 2 (e) and (f), as well as Figure S2).  
In this case, SMA on the $d=285nm$ nanosphere
leads to generation of hot carriers within 1 eV of the Fermi energy,   
