...
of the metal that is self-consistent across the electroydynamics and quantum dynamics domains may also be valuable and will be explored.  Currently, the electrodynamics
...
Analogous calculations to those presented in this work that utilze size-dependent corrections to
...
(see Figure S5). In principle, the dielectric function may be derived directly from electronic struture calculations of
the metal nanoparticles, and so a self-consistent approach would include deriving the dielectric
function from the same electronic structure model used for the many-electron dynamics.}   
