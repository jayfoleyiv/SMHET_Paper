...
\end{equation}
We order the orbitals by a single index $p$ such that $\epsilon_{p+1} \geq \epsilon_p$.
...
Using the above expressions, the diagonal matrix elements can be evaluated as
\begin{align}
