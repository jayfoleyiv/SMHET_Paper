...
\begin{tocentry}
\includegraphics[width=3.5in]{nanosphere_WGMv3.png}
\end{tocentry}
...
Supporting Information.  Additional Figures illustrating hot carrier distributions and dynamics, as well as details of the time-dependent
