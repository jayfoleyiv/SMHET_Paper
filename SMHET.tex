...
a $d=270nm$ dielectric NS has a broad scattering resonance (herein referred to as a Fabry-Perot (FP) resonance) that overlaps 
with an Au transition at 3.1 eV, and
a $d=685nm$ dielectric NS has narrow scattering resonances (whispering gallery modes (WGM)) that overlap with every transition between 1.3 and 3.3 eV.
...
These differences can be attributed in part to the unique ways in which each resonant interaction modulates the incident optical
fields in space and time. An illustration of the former can be see in the electric field intensity maps at the resonance frequency for the 
Au LSPR (Figure 1(a)), FP resonance (Figure 1(b)), and WGM resonance (Figure 1(c)), which shows a progressive increase in maximum nearfield
enhancement associated with these resonances.  The larger nearfield enhancement associated with the dielectric scattering resonances
...
of hot-carriers.  Similarly, a progression of resonance lifetime can be inferred for these resonances from their extinction spectra, with 
the Au LSPR having the broadest extinction peak and the shortest lifetime, and the WGM having the narrowest extinction peaks and longest lifetimes.  
