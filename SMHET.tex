...
commensurate impact on the electronic dynamics, we consider SMA by a series of Au-decorated dielectric
nanospheres with sizes between 6
-Frequency of scattering resonances can be systematically varied via geometry
-Progression of geometries can be brought progressively into resonance with Au transitions
-Both resonant and off-resonant scattering is observed to lead to efficient hot-carrier generation
-On resonance, shows 2-fold enhancement in hot-carrier generation.
...
\begin{equation}
{\bf \hat{\mu} } = \hat{\mu}_x {\bf \hat{i}} + \hat{\mu}_y {\bf \hat{j}} + \hat{\mu}_z {\bf \hat{k}}.
\end{equation}
...
\langle \Phi_i^a | \hat{H}(t) | \Phi_j^b \rangle &= \delta_{ij} \langle \psi_a | {\bf E}(t) \cdot {\bf \hat{\mu}} | \psi_b \rangle - \delta_{ab} \psi_i | {\bf E}(t) \cdot {\bf \hat{\mu}} | \psi_j \rangle.
\end{align} 
