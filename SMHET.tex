...
are computed as $^1D^q_q(t)-^1D^q_q(t=0)$, and similiarly for the change in occupations plotted
...
broad distribution of energies in the incident optical fields that encounter the metal nanoparticles combined with
the density of available transition channels.  By contrast, analogoues calculations that have a lower density of
...
Additional developments that focus on a treatement of the optical properties
of the metal that is self-consistent across the electroydynamics and quantum dynamics domains may also be valuable and will be explored.  In principle, the dielectric function may be derived directly from electronic struture calculations of
...
Analogous calculations that utilze size-dependent corrections to
dielectric function in the electrodymanics calculations suggest that the hot-electron dynamics
