...
compared free-electron and Jellium-LDA models and found that correlation effects within the LDA have a negligible impact 
...
As shown in previous work, the inclusion of many-body effects can impact the calculation
