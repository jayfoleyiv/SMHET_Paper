...
and found negligible impact on hot carrier generation and dynamics in Ag nanospheres resulting from electron correlation~\cite{MLK_ACSNano_2014}.  However, many-body effects are not negligible for hot-carrier dynamics
...
\textcolor{red}{The explicit time-dependence  of the TDCIS approach allows us to capture transitions that become important as the nearfields from the
scattering resonances continue to interact with the metal electrons for 10s to 100s of femtoseconds.  Over these timescales, population in 
various excited configurations begin to accumulat and transitions between different excited configurations become important to the dynamics.  
This is a unique feature of SMA that is likely unimportant to in plamonic generation of hot-carriers due to the impulsive nature of the plasmon field.  Approaches
which rely on linear response theory or upon time-dependent pertubation theory that have been sucessfully used to study plasmon generated
hot-carriers involve dipolar coupling terms only between ground and excited configurations, and hence neglect the transitions between different }
