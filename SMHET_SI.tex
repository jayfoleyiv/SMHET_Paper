...
line labelled SMA Full TDCIS) and one where
excited-to-excited configurations are neglected in the spirit of approaches based on linear-response
theory and time-dependent perturbation theory to first order (black line labelled SMA Linear Response).  While the two approaches agree at short
...
\caption{Comparison of hot-electron dynamics with from SMA with (black line labelled SMA with SC) and without
(purple line labelled SMA) a phenomenological size
